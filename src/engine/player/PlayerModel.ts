...
const ARMOR_COLORS: Record<number, number> = {
  ...
  [BLOCK_ID.IRON_HELMET]: 0xd0d0d0,
  [BLOCK_ID.IRON_CHESTPLATE]: 0xd0d0d0,
  [BLOCK_ID.IRON_LEGGINGS]: 0xd0d0d0,
  [BLOCK_ID.IRON_BOOTS]: 0xd0d0d0,
  [BLOCK_ID.DIAMOND_HELMET]: 0x5ce0e8,
  [BLOCK_ID.DIAMOND_CHESTPLATE]: 0x5ce0e8,
  [BLOCK_ID.DIAMOND_LEGGINGS]: 0x5ce0e8,
  [BLOCK_ID.DIAMOND_BOOTS]: 0x5ce0e8,
};
